# Learning2014_linear regression
...
4 after removing the parameters of stra and surf. we have our model3, attitude is the only variable hitting significance level, below 0.05
```{r}
